...
<!--                     <div class="course-body-on-cover text-white">
                    ...
                    <div class="<?php if(!$course->isCourse()): ?> mt-35 <?php else: ?> mt-5 pt-5 <?php endif; ?>">
...
<!--                             <?php if($course->price > 0): ?>
                                <div id="priceBox" class="d-flex align-items-center justify-content-center mt-20">
                                    <span id="realPrice" data-value="<?php echo e($course->price); ?>"
                                          ...
                                          class="<?php if(!empty($activeSpecialOffer)): ?> font-16 text-gray text-decoration-line-through mr-15 <?php else: ?> font-30 text-primary <?php endif; ?>"><?php echo e($currency); ?><?php echo e(number_format($course->price,2)); ?></span>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>