                                            ...
                                            <div class="feature-footer mt-auto d-flex align-items-center justify-content-between">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="date-published ml-5 text-dark-blue font-14">{{ dateTimeFormat(!empty($feature->webinar->start_date) ? $feature->webinar->start_date : $feature->webinar->created_at,'j F Y') }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="feature-price-box">
                                                    ...
                                                    @if($feature->webinar->bestTicket() < $feature->webinar->price)
                                                   <span class="real">{{ $currency }}{{ number_format($feature->webinar->bestTicket(), 2, ".", "")+0 }}</span>
                                                  @else
